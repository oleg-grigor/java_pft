 ...
 * 2020-04-05T19:01:10.221+03:00
 * Generated source version: 3.3.6
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/main/resources/wsgeoip.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/wsgeoip.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/wsgeoip.wsdl");
        }
        WSDL_LOCATION = url;
    }
